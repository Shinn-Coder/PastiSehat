    ...
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-12 pb-32">
      <div className="flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-gray-500 font-medium">Personalisasi pengalaman PastiSehat Anda.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 md:p-10 shadow-sm space-y-8">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-bold">Notifikasi Pengingat</h2>
          </div>
          
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-bold">Notifikasi Aplikasi</p>
                <p className="text-sm text-gray-500 font-medium">Terima pengingat janji temu di aplikasi.</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-bold">Notifikasi WhatsApp</p>
                <p className="text-sm text-gray-500 font-medium text-balance">Kirim pengingat otomatis ke nomor WhatsApp Anda.</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
        ...
        {/* Privasi & Keamanan */}
        <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 md:p-10 shadow-sm space-y-8 text-balance">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-secondary/50 rounded-2xl flex items-center justify-center text-primary">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-sm">Sembunyikan Rekam Medis</p>
                    <p className="text-xs text-gray-500 font-medium">Data medis tidak tampil di dashboard utama.</p>
                  </div>
               </div>
               <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 md:p-10 shadow-sm space-y-8">
           <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-bold">Tampilan & Bahasa</h2>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <select 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 rounded-2xl outline-none font-bold text-sm appearance-none border-2 border-transparent focus:border-primary/20"
                >
